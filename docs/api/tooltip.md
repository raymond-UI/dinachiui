...
onOpenChange
(open: boolean, event?: Event, reason?: Tooltip.Root.OpenChangeReason) => void
...
className
| string
| ((state: Tooltip.Trigger.State) => string)

undefined

render
| ReactElement
| ((props: HTMLProps, state: Tooltip.Trigger.State) => ReactElement)
...
render
| ReactElement
| ((props: HTMLProps, state: Tooltip.Positioner.State) => ReactElement)
...
className
| string
| ((state: Tooltip.Popup.State) => string)

undefined

render
| ReactElement
| ((props: HTMLProps, state: Tooltip.Popup.State) => ReactElement)
...
className
| string
| ((state: Tooltip.Arrow.State) => string)

undefined

render
| ReactElement
| ((props: HTMLProps, state: Tooltip.Arrow.State) => ReactElement)
